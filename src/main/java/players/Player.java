...
public abstract class Player {
	...
	/**
	 * Returns the counter ID of the opponent.
	 */
	public int getOpponentCounter() {
		return (this.id == GameState.COUNTER_DARK) ? GameState.COUNTER_LIGHT : GameState.COUNTER_DARK;
	}

	/**
	 * Returns the counter ID controlled by the player.
	 */
